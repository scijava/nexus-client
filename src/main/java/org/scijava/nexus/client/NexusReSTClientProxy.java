...
public interface NexusReSTClientProxy {
	 ...
	 * 
	 * @param id
	 *            of asset to be retrieved
	 * @return a JSON list of the asset information, including the direct
	 *         download URL
	 */
	@GET
